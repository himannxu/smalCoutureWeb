...
const Header = () => {
  ...
  useEffect(() => {
    if (!isDesktop) setActiveDesktopMenu(null)
  }, [isDesktop])
  ...
  return (
    ...
    {!isDesktop && <header
      className="m-header__mobile container-fluid m:flex m:items-center m-gradient m-color-default"
        ...
        <a
          ...
          <div
            ...
            <img
              ...
              height="33"
              src="//fashion.minimog.co/cdn/shop/files/logo_a3f90005-86fb-4996-8c21-b46c5011524e.png?v=1709089146"
      ...
      <div
        className={`m-menu-drawer${isMenuOpen ? ' is-open' : ''}`}
        id="m-menu-drawer"
        hidden={!isMenuOpen}
        {...drawerProps}
      >
          ...
          <div className="m-menu-drawer__content">
            <ul className="m-menu-drawer__navigation m-menu-mobile">
              <li className="m-menu-mobile__item" data-index="0" data-url="#">
                ...
                <div className="m-megamenu-mobile m-megamenu-mobile--level-1">
                  <div className="m-megamenu-mobile__wrapper">
                    <button className="m-menu-mobile__back-button" data-level="1">
                      <svg
                        fill="none"
                        viewBox="0 0 16 17"
                        xmlns="http://www.w3.org/2000/svg">
              ...
              <li
                ...
                <a className="m-menu-mobile__link" href="/collections/all">
                  <span>Shops</span>
                </a>
                <span
                  className="m-menu-mobile__toggle-button"
                  ...
                  <div className="m-megamenu-mobile__wrapper">
                    ...
                    <foxkit-menu
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069J1eXs"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/long-denim-skirt?preview_theme_id=126026973289"
                          title="Grid 1 columns">
                          <span className="f-menu__label">Grid 1 columns</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069rU2Tx"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/oversized-denim-shirt-jacket?preview_theme_id=126026973289"
                          title="Grid mix">
                          <span className="f-menu__label">Grid mix</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069vSnwc"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://demo.minimog.co/products/denim-jacket?preview_theme_id=125615669438"
                          title="Slider 1 column">
                          <span className="f-menu__label">Slider 1 column</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069MZoVw"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/quilted-shopper?preview_theme_id=126026973289"
                          title="Slider 2 columns">
                          <span className="f-menu__label">Slider 2 columns</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069pRo8J"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/wool-blend-jacket?preview_theme_id=126027235433"
                          title="Slider vertical">
                          <span className="f-menu__label">Slider vertical</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-17102160697xLHH"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/boxy-denim-jacket?preview_theme_id=126026973289"
                          title="Sider full-width">
                          <span className="f-menu__label">Sider full-width</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069Mffwd"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/store-gift-card?preview_theme_id=126026973289"
                          title="Gift card">
                          <span className="f-menu__label">Gift card</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                      ...
                      <foxkit-menu-dropdown
                        ...
                        <a
                          ...
                          <span className="f-menu__label">Lightbox image</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069nscal"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://next.minimog.co/products/calendar-postcard?preview_theme_id=127300599985"
                          title="Custom field">
                          <span className="f-menu__label">Custom field</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-17102160692wgbu"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/oversized-denim-shirt-jacket?preview_theme_id=126026973289"
                          title="Short description">
                          <span className="f-menu__label">Short description</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069RiWEO"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/cotton-bucket-hat-black-patterned?preview_theme_id=126026973289"
                          title="Trust badge">
                          <span className="f-menu__label">Trust badge</span>
                        </a>
                      </foxkit-menu-dropdown>
                      <foxkit-menu-dropdown
                        class="f-menu__item f-menu__item--mega f-menu__item-parent f-menu__item--container-full"
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069XrwHD"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/oversized-denim-shirt-jacket?preview_theme_id=126026973289"
                          title="Collapsible tabs information">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069cRgz2"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/cotton-bucket-hat-black-patterned?preview_theme_id=126026973289"
                          title="Product tabs information">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-17102160694oNlr"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/oversized-denim-shirt-jacket?preview_theme_id=126026973289"
                          title="Product recently viewed">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069hgB36"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/oversized-denim-shirt-jacket?preview_theme_id=126026973289"
                          title="Product recommentdations">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069dDGJ9"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://minimog-fashion.myshopify.com/products/long-denim-skirt?preview_theme_id=126026973289"
                          title="Product complementary">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069Y5k0F"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://next.minimog.co/products/wireless-speaker-black?preview_theme_id=127219990705"
                          title="Single product layout 1">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-171021606929wQa"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://next.minimog.co/products/wireless-speaker-earth-tone?preview_theme_id=127219990705"
                          title="Single product layout 2">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-171021606938wiD"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://next.minimog.co/products/wireless-speaker-gold-tone?preview_theme_id=127219990705"
                          title="Single product layout 3">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069cw4Y9"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://next.minimog.co/products/calendar-postcard?preview_theme_id=127300599985"
                          title="Single product layout 4">
                          <span className="f-menu__label">
                      ...
                      <foxkit-menu-dropdown
                        ...
                        data-level="1"
                        data-trigger="hover"
                        id="f-1710216069W78uR"
                        role="menuitem">
                        <a
                          className="f-menu__link f-menu__link--level-1"
                          href="https://next.minimog.co/products/dried-flower-card?preview_theme_id=127300599985"
                          title="Single product layout 5">
                          <span className="f-menu__label">
    ...
    {isDesktop && <header
      className="m-header__desktop logo-center-menu-left m-gradient m-color-default"
      ...
      <div className="m-header__container container-fluid">
        <div className="m-header__inner">
          ...
          <div className="m-header__center m:w-2/12">
            <h1 className="m-header__logo m-logo m-logo--has-image">
              <a
                className="m-logo__image m:block"
                href="/"
                title="Minimog Fashion Store">
          ...
          <div className="m-header__right m:w-5/12">
            ...
            <a aria-label="Account" className="m-header__account" href="/account">
              <span className="m-tooltip m:block m-tooltip--bottom m-tooltip--style-2">
                <svg
                  className="m-svg-icon--medium"
                  fill="currentColor"
            ...
            <a
              ...
              <sup className="m-wishlist-count m:hidden">0</sup>
            </a>
            <a
              aria-haspopup="dialog"
              aria-label="1"
